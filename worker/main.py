...
def get_30min_window(dt):
    """Get the start of the current 30-minute window in UTC (rounds down to :00 or :30)"""
    if dt.minute < 30:
    ...
    try:
        ...
        if is_new_window:
            ...
            if update_data:
                ...
                logger.info(f"✅ Updated {update_count} PriceHistory records")
